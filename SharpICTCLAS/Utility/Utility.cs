...
namespace SharpICTCLAS
{
    public sealed class Utility
    {
        ...
        //====================================================================
        // ½«×Ö·û´®×ª»»Îª×Ö½ÚÊý×é£¨ÓÃÓÚ½«ºº×ÖÐèÒª²ð·Ö³É2×Ö½Ú£©Ö»×ª»»Ê××Ö·û
        //====================================================================
        ...
        static Regex IsAllNumRegex = new Regex(@"^[¡À+£­\-£«]?[£°£±£²£³£´£µ£¶£·£¸£¹\d]*[¡Ã¡¤£®£¯./]?[£°£±£²£³£´£µ£¶£·£¸£¹\d]*[°ÙÇ§ÍòÒÚ°ÛÇª£¥¡ë%]?$", RegexOptions.Compiled);
        //====================================================================
        ...
        static Regex IsAllChineseNumRegex = new Regex(@"^[¼¸ÊýµÚÉÏ³É]?[Áã¡ðÒ»¶þÁ½ÈýËÄÎåÁùÆß°Ë¾ÅÊ®Ø¥°ÙÇ§ÍòÒÚÒ¼·¡ÈþËÁÎéÂ½Æâ°Æ¾ÁÊ°°ÛÇª¡Ã¡¤£®£¯µã]*[·ÖÖ®]?[Áã¡ðÒ»¶þÁ½ÈýËÄÎåÁùÆß°Ë¾ÅÊ®Ø¥°ÙÇ§ÍòÒÚÒ¼·¡ÈþËÁÎéÂ½Æâ°Æ¾ÁÊ°°ÛÇª]*$", RegexOptions.Compiled);
        //====================================================================
        ...
        public static int CCStringCompare(string ca1, string ca2)
        {
            ...
            for (int i = 0; i < minLength; i++)
            {
                ...
                else
                {
                    ...
                    if (ca1int < 128 && ca2int < 128) //Èç¹ûÁ½¸ö×Ö·û¶¼ÊÇ°ë½Ç
                    {
                        if (ca1[i] < ca2[i])
                            return -1;
                        else if (ca1[i] > ca2[i])
